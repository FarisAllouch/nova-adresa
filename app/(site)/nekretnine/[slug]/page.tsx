...
import { stanovi } from "../data";

export default async function Page({ params }: { params: Promise<{ slug:string }> }) {

    const { slug } = await params
    const stan = stanovi.find(s => s.slug === slug);
    ...
    return (
        <div className="max-w-7xl mx-auto py-12 px-5">
            ...
            <div className="mt-16 p-10 bg-neutral-900 rounded-2xl text-center text-white shadow-lg">
                ...
                <p className="text-neutral-300 mb-6">Kontaktirajte nas za više informacija ili obilazak stana.</p>
